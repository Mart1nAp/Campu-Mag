...
public class MetodosSQL {
    ...
    public boolean registrarUsuario(String curp, String nombre, String apellidos, String correo, String contrasena, String usuarioGeneradoAutomaticamente) {
        boolean registro = false;

        try {
            conexion = ConexionBD.conectar();
            String consulta = "INSERT INTO usuarios (curp,nombre,apellidos,correo,contrasena,usuario_generado_automaticamente) VALUES (?,?,?,?,?,?)";
            ...
            sentenciaPreparada.setString(5, contrasena);
