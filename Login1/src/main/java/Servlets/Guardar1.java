...
public class Guardar1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuarioRepetido == true) { //EL usuario ya esta registrado en la BD
            ...
            boolean registro = metodos.registrarUsuario(txtCurp, txtNombre, txtApellidos, txtCorreo, txtContrasena, txtUsuarioGeneradoAutomaticamente);
